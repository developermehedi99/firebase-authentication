                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    <form onSubmit={handleRegistar} className="card-body">
                        <div className="form-control">
                            ...
                            <input type="text" name="name" required placeholder="email" className="input input-bordered" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                    ...
                    <p className="pb-5 px-5">Already have account? please <Link to="/login" className="font-bold border-4 p-2 text-red-600">Login</Link></p>
                </div>
            </div>
        </div>
    );
